...
--  envelope, and wire-format decisions stay inside libitb3. Finalize
...
package Itb3.Stream is
   ...
   procedure Begin_Encrypt
     (S : in out Encrypt_Stream; P : Itb3.Pipeline.Pipeline);
   procedure Begin_Decrypt
     (S : in out Decrypt_Stream; P : Itb3.Pipeline.Pipeline);
   ...
   --  Itb_Error with Itb3.Status.Bad_Input.
