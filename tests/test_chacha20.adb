--  ChaCha20-focused Ada binding coverage.
--
--  Mirrors bindings/rust/tests/test_chacha20.rs one-to-one. Each Rust
...
procedure Test_Chacha20 is
   ...
   --  ChaCha20 carries a 32-byte fixed key.
...
begin
   ...
   Ada.Text_IO.Put_Line ("test_chacha20: PASS");
