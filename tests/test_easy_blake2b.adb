--  BLAKE2b-focused Easy Mode (Itb.Encryptor) coverage.
--
--  Symmetric counterpart to bindings/rust/tests/test_easy_blake2b.rs
--  applied to the high-level Itb.Encryptor surface. Iterates both
--  BLAKE2b widths — blake2b256 (-256) and blake2b512 (-512).
--
...
procedure Test_Easy_Blake2b is
   ...
   Hashes : constant Hash_Spec_Array :=
     [(To_Unbounded_String ("blake2b256"), 256, 32),
      (To_Unbounded_String ("blake2b512"), 512, 64)];
...
begin
   ...
   Ada.Text_IO.Put_Line ("test_easy_blake2b: PASS");
