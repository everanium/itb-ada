--  BLAKE3-focused Ada binding coverage.
--
--  Mirrors bindings/rust/tests/test_blake3.rs one-to-one. Each Rust
...
procedure Test_Blake3 is

   Hash_Name : constant String := "blake3";
   Width     : constant Integer := 256;

   --  BLAKE3 carries a 32-byte fixed key.
...
begin
   ...
   Ada.Text_IO.Put_Line ("test_blake3: PASS");
