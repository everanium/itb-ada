--  ChaCha20-focused Easy Mode (Itb.Encryptor) coverage.
--
--  Symmetric counterpart to bindings/rust/tests/test_easy_chacha20.rs
--  applied to the high-level Itb.Encryptor surface. ChaCha20 ships
--  only at -256.
--
...
procedure Test_Easy_Chacha20 is

   Hash_Name : constant String := "chacha20";
   Width     : constant Integer := 256;

   --  ChaCha20 carries a 32-byte fixed PRF key.
...
begin
   ...
   Ada.Text_IO.Put_Line ("test_easy_chacha20: PASS");
